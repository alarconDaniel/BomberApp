...
export default function DetailsInventoryItemModal({
    ...
    React.useEffect(() => { if (visible && !mounted) setMounted(true); }, [visible, mounted]);
                ...
                <Pressable style={[s.card, s.shadow]} onPress={() => {}}>
                    ...
                    <View style={s.mediaRow}>
                        <View style={s.iconWrap}>
                            <Image source={localImg} style={{ width: 102, height: 102, borderRadius: 12 }} contentFit="contain" cachePolicy="memory-disk" transition={120} />
                        </View>
                    ...
                    <View style={s.footer}>
                        ...
                        {tipo === 'COFRE' && (
                            <Pressable onPress={onOpenChest} disabled={!onOpenChest || opening || cantidad <= 0} style={s.actionBtn}>
