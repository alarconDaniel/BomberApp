...
export default function OperariosScreen() {
    ...
    // 🔔 Para detectar creaciones sin tocar otras pantallas:
    // guardamos el conjunto previo de IDs y evitamos sonar en la primera carga.
    ...
    // Aplica una lista nueva, detecta altas y reproduce "campana" si corresponde
    const applyList = useCallback((arr: OperarioUI[]) => {
        ...
        // Evitar sonar en el primer render; a partir de la segunda, si hay nuevos IDs → "campana"
