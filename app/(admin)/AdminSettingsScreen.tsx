                        ...
                        <SettingRow
                            ...
                            right={
                                <Switch
                                    value={notif}
                                    onValueChange={(val) => {
                                        // sonido de switch al togglear notificaciones
                                        play('switch');
                                        setNotif(val);
                                    }}
                        ...
                        <SettingRow
                            ...
                            right={
                                <Switch
                                    value={sounds}
                                    onValueChange={(val) => {
                                        // sonido de switch al togglear sonidos globales
                                        play('switch');
                                        setSounds(val);
                                        // sincroniza el engine global de sonidos
